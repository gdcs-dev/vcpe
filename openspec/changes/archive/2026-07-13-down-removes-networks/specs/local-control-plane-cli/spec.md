...
- **THEN** after stopping all compose services the system removes the Podman networks that were created for the deployment, and the deployment networks no longer appear in `podman network ls`
