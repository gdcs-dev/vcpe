...
#### Scenario: Image deduplication across manifests
- **WHEN** two manifests both declare a `bng` service with the same `repository` and `buildContext`
- **THEN** the image is built and pushed exactly once
