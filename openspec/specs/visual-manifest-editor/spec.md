## Purpose
Define the VS Code visual manifest editor extension that renders vcpe.dev/v1 manifests as an interactive topology canvas with bidirectional YAML synchronization.
