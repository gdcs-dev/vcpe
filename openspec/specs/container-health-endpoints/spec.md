## Purpose
Define the common HTTP health endpoint contract that every curated vCPE container image implements, including type-owned readiness checks, Gateway/WebPA registration readiness, OCI healthcheck parity, and opt-in health for generic containers.
