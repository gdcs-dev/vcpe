## Purpose
Define bounded, deployment-targeted diagnostics for subscriber webhook registration and callback delivery while preserving credential and payload safety.
