# cross-network-device-dns Specification

## Purpose

Define deterministic, deployment-scoped DNS publication and routing so management services can reliably reach devices across BNG-connected networks.
