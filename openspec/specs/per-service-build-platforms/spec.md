## Purpose
Define per-service platform override behavior for `vcpe build` and `vcpe release`, allowing individual services to constrain which OS/arch platforms their image is built for.
